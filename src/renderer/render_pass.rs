...
pub(crate) fn setup_render_pass(logical_layer: &LogicalLayer, render_target: &RenderTarget, depth_format: vk::Format) -> vk::RenderPass {
    ...
    let attachment_desc_array = [attachment_desc, depth_attachment_desc];
