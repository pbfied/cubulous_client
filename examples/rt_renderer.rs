...
use renderlib::renderutils::{cast_to_u8_slice, create_common_vulkan_objs};
use renderlib::rt_accel::{create_acceleration_structures, RtBlas, RtTlas};
use renderlib::rt_canvas::RtCanvas;
use renderlib::rt_descriptor::{create_descriptor_sets, create_per_frame_descriptor_set_layout, create_singleton_descriptor_set_layout, destroy_descriptor_sets};
use renderlib::rt_pipeline::{RtMissConstants, RtPipeline};
use renderlib::rt_ubo::RtUniformBuffer;

const MAX_FRAMES_IN_FLIGHT: usize = 2;
const CLEAR_COLOR: RtMissConstants = RtMissConstants {
    clear_color: Vector4 {
        x: 0.3,
        y: 0.3,
        z: 0.3,
    ...
    fn record_command_buffer(&self, image_index: u32) {
        ...
        unsafe {
            ...
            logical_device.cmd_push_constants(command_buffer, self.rt_pipeline.pipeline_layout,
                                              vk::ShaderStageFlags::MISS_KHR, 0,
                                              // &[0x9a, 0x99, 0x99, 0x32, 0x9a, 0x99, 0x99, 0x32, 0x9a, 0x99, 0x99,
                                              //     0x32, 0x0, 0x0, 0x0, 0x0, 0x9a, 0x99, 0x99, 0x32, 0x9a, 0x99, 0x99, 0x32, 0x9a, 0x99, 0x99,
                                              //     0x32, 0x0, 0x0, 0x0, 0x0, 0x9a, 0x99, 0x99, 0x32, 0x9a, 0x99, 0x99, 0x32, 0x9a, 0x99, 0x99,
                                              //     0x32, 0x0, 0x0, 0x0, 0x0, 0x9a, 0x99, 0x99, 0x32, 0x9a, 0x99, 0x99, 0x32, 0x9a, 0x99, 0x99,
